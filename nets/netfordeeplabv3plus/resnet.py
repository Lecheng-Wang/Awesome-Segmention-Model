...
def resnet152(downsample_factor=32, bands=3, **kwargs):
    model = ResNet(block_type=BasicBlock, block_config=[3, 8, 36, 3], num_classes=1000, bands=bands, downsample_factor=downsample_factor)
    return model
...
if __name__ == "__main__":
    ...
    print("Low level output shape:", output[0].shape)
    print("High level output shape:", output[1].shape)
